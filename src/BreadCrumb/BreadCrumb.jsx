...
const BreadCrumb = ({ title, home }) => {
  ...
  return (
    <section className="bg-[url('/images/home-1/Lewi-Resort-Wolaita-Sodo-Deluxe-Double.jpg')] bg-no-repeat bg-cover h-[550px] bg-center grid items-center justify-center">
